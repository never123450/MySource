package com.xwy.MySpringIOC.context.support;
 ...
 * @return
 */
public class XwyBeanDefinitionReader {
    ...
    public XwyBeanDefinitionReader(String... locations) {
    ...
    //只是为了对配置信息进行一个包装
    public XwyBeanDefinition registerBean(String className) {
        if (this.registyBeanClasses.contains(className)) {
            XwyBeanDefinition beanDefinition = new XwyBeanDefinition();
