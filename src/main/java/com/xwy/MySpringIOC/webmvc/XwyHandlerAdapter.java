 ...
 */
//专人干专事
public class XwyHandlerAdapter {

    private Map<String,Integer> paramMapping;

    public XwyHandlerAdapter(Map<String,Integer> paramMapping){
     ...
     * @return
     */
    public XwyModelAndView handle(HttpServletRequest req, HttpServletResponse resp, XwyHandlerMapping handler) throws  Exception {
        ...
        boolean isModelAndView = handler.getMethod().getReturnType() == XwyModelAndView.class;
        if(isModelAndView){
            return (XwyModelAndView)result;
        }else{
            return null;
        }
    }
