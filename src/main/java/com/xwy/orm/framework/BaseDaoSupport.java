...
import com.xwy.orm.javax.core.common.Page;
import com.xwy.orm.javax.core.common.utils.BeanUtils;
import com.xwy.orm.javax.core.common.utils.DataUtils;
import com.xwy.orm.javax.core.common.utils.GenericsUtils;
import com.xwy.orm.javax.core.common.utils.StringUtils;
...
//			return clazz.cast(key);
    ...
    private Map<String, Object> convertMap(Object obj) {
        ...
        for (int i = 0, len = getters.size(); i < len; i++) {
            ...
            String name = fieldInfo.getMember().getName();
            try {
