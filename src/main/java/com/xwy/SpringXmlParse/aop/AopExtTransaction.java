...
import com.xwy.SpringXmlParse.annotation.ExtTransaction;
import com.xwy.SpringXmlParse.transaction.TransactionUtils;
...
public class AopExtTransaction {
	...
	// 使用异常通知进行 回滚事务
	@AfterThrowing("execution(* com.xwy.SpringXmlParse.service.*.*.*(..))")
	...
	// 环绕通知 在方法之前和之后处理事情
	@Around("execution(* com.xwy.SpringXmlParse.service.*.*.*(..))")
