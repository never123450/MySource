...
import com.xwy.SpringXmlParse.utils.ClassUtil;
...
public class ExtDispatcherServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		// 1.获取当前包下的所有的类
		List<Class<?>> classes = ClassUtil.getClasses("com.xwy.springMVC.controller");
