...
package com.xwy.rateLimiter.implementation.aop;
...
import com.xwy.rateLimiter.implementation.annotation.ExtRateLimiter;
...
public class RateLimiterAop {
	...
	// 定义切入点 拦截com.xwy.rateLimiter.implementation.api
	@Pointcut("execution(public * com.xwy.rateLimiter.implementation.api*.*(..))")
	public void rlAop() {
	}
